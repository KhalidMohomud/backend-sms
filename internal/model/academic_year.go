...
type AcademicYear struct {
	ID        uint64    `gorm:"column:y_no;primaryKey" json:"id"`
	SchoolID  uint64    `gorm:"column:sch_no;not null;uniqueIndex:uq_academic_year_school_name" json:"school_id"`
	...
	EndsOn    time.Time `gorm:"column:ended;type:date;not null" json:"ends_on"`
